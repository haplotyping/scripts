...
class ValidateGeneral:
    ...
    def __init__(self, dataPath:str, schemaPath:str, resourceFilename:str, **args):
...
class ValidatePedigree(ValidateGeneral):
    ...
    def __init__(self, dataPath:str, schemaPath:str, resourceFilename:str, **args):
        ...
        super(ValidatePedigree, self).__init__(dataPath, schemaPath, resourceFilename, **args)
...
class ValidateData(ValidateGeneral):
    ...
    def __init__(self, dataPath:str, schemaPath:str, resourceFilename:str, pedigreePackage:str, **args):
        
        super(ValidateData, self).__init__(dataPath, schemaPath, resourceFilename, **args)
